...
public static class NoiseS3Ds 
{
	...
	static int[][] grad4 = {new int[]{0,1,1,1}, new int[]{0,1,1,-1},  new int[]{0,1,-1,1},  new int[]{0,1,-1,-1},
	...
	static void SetShaderVars(ComputeShader shader, Vector2 noiseOffset, bool normalize, float noiseScale, int kernel) {
	...
	static Texture2D ToTexture2DNoise(RenderTexture inTex, bool apply = true, bool release = false, TextureFormat format = TextureFormat.RGBA32) {
	...
	static string shaderPath = "Shaders/NoiseS3DGPU";
	static string noShaderMsg = "Could not find the noise compute shader. Did you move/rename any of the files?";
